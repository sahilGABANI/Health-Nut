...
class ModifierOptionAdapter(private val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ViewType.OrderOptionItemItemViewType.ordinal -> {
                OrderOptionItemViewHolder(ModificationOptionView(context).apply {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (adapterItem) {
            is AdapterItem.ModificationOptionItem -> {
                (holder.itemView as ModificationOptionView).bind(adapterItem.subOrderItemData)
            }
        }
    }
